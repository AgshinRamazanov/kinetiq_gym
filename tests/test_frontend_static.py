...
class FrontendStaticTests(unittest.TestCase):
    ...
    def test_account_recovery_deletion_and_versioned_sync_are_wired(self):
        ...
        self.assertIn('id="verification-result"', index)
        self.assertIn('id="verification-result-action"', index)
        ...
        self.assertIn("showVerificationResult(true)", cloud)
        self.assertIn("authRedirectUrl('verification')", cloud)
